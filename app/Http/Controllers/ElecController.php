...
class ElecController extends Controller
{
    ...
    {
        $records = Elec::all();
        return view('admin.Elec.index',compact('records'));
    }
...
//        return redirect('Elec/fees')->with([
...
//        return $request->all();
    ...
    public function getStudents(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.Elec.index',compact('students','sclass_id','section_id','group_id','session','fund_id'));
    }

    public function feeEdit()
    {
        return view('admin.Elec.edit');
    }
    ...
    public function getStudentsEdit(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.Elec.edit',compact('students','department','semester','session'));
    }

    public function feeUpdate(Request $request)
    {
        foreach($request['student_ids'] as $student_id) {
            $fee = Elec::find($student_id);
