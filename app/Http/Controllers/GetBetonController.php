...
class GetBetonController extends Controller
{
    public function index()
    {
        $records = GetBeton::all();
        return view('admin.GetBeton.index',compact('records'));
    }
    ...
    public function getStudents(Request $request)
    {
        ...
        $exam_id = $request['exam_id'];
        $session = $request['session'];
        return view('admin.GetBeton.index',compact('students','sclass_id','section_id','group_id','session','exam_id'));
    }

    public function feeEdit()
    {
        return view('admin.GetBeton.edit');
    }
    ...
    public function getStudentsEdit(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.GetBeton.edit',compact('students','department','semester','session'));
    }

    public function feeUpdate(Request $request)
    {
        foreach($request['student_ids'] as $student_id) {
            $fee = GetBeton::find($student_id);
