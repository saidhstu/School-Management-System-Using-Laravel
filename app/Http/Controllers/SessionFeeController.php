...
class SessionFeeController extends Controller
{
    ...
    {
        $records = SessionFee::all();
        return view('admin.SessionFee.index',compact('records'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('session/fees')->with([
...
//        return $request->all();
    ...
    public function getStudents(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.SessionFee.index',compact('students','sclass_id','section_id','group_id','session','fund_id'));
    }

    public function feeEdit()
    {
        return view('admin.SessionFee.edit');
    }
    ...
    public function getStudentsEdit(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.SessionFee.edit',compact('students','department','semester','session'));
    }

    public function feeUpdate(Request $request)
    {
        foreach($request['student_ids'] as $student_id) {
            $fee = SessionFee::find($student_id);
