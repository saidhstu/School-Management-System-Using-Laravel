...
class AttendencePaymentController extends Controller
{
    public function index()
    {
        $records = AttendencePayment::all();
        return view('admin.AttendencePayment.index',compact('records'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $record = AttendencePayment::find($id);
    ...
    public function getStudents(Request $request)
    {
        ...
        $exam_id = $request['exam_id'];
        $session = $request['session'];
        return view('admin.AttendencePayment.index',compact('students','sclass_id','section_id','group_id','session','exam_id'));
    }

    public function feeEdit()
    {
        return view('admin.AttendencePayment.edit');
    }
    ...
    public function getStudentsEdit(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.AttendencePayment.edit',compact('students','department','semester','session'));
    }

    public function feeUpdate(Request $request)
    {
        foreach($request['student_ids'] as $student_id) {
            $fee = AttendencePayment::find($student_id);
