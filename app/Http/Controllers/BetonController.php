...
class BetonController extends Controller
{
    ...
    {
        $records = Beton::all();
        return view('admin.Beton.index',compact('records'));
    }
...
//        return redirect('beton/fees')->with([
...
//        return $request->all();
    ...
    public function getStudents(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.Beton.index',compact('students','sclass_id','section_id','group_id','session','fund_id'));
    }

    public function feeEdit()
    {
        return view('admin.Beton.edit');
    }
    ...
    public function getStudentsEdit(Request $request)
    {
        ...
        $session = $request['session'];
        return view('admin.Beton.edit',compact('students','department','semester','session'));
    }

    public function feeUpdate(Request $request)
    {
        foreach($request['student_ids'] as $student_id) {
            $fee = Beton::find($student_id);
